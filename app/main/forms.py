...
class CreateThreadForm(FlaskForm):
    name = TextField(_l('Thread Name'), validators=[DataRequired()])
    description = TextAreaField(_l('Thread Description'), validators=[DataRequired()])
    submit = SubmitField(_l('Submit'))

class PostForm(FlaskForm):
    post = TextAreaField(_l('Post something'), validators=[DataRequired()])
    submit = SubmitField(_l('Submit'))
